...
import com.codingcrucible.arrow.TextChunk;
import com.codingcrucible.arrow.PngConfig;
import com.codingcrucible.arrow.SuggestedPalette;
import com.codingcrucible.arrow.PngConstants;
...
extends PngTestCase
{
    ...
    throws Exception
    {
        new PngImage().read(getClass().getResourceAsStream("/images/broken/gama_zero.png"));
    }
    ...
    throws Exception
    {
        PngImage png = new PngImage(new PngConfig.Builder()
                                    ...
                                    .build());
        BufferedImage image = png.read(getClass().getResourceAsStream(path));
    ...
    throws Exception
    {
        ...
        //TODO: fix the dummy
        javax.imageio.ImageIO.write(png.read(in), "PNG", file);
